...
async def run_test():
    ...
    try:
        ...
        # -> Click on 'Sign In' to log in with test user credentials.
        ...
        # -> Retry login with pro@test.com credentials or verify correct password for free@test.com.
        frame = context.pages[-1]
        ...
        # -> Retry login with promax@test.com credentials.
        frame = context.pages[-1]
        ...
        try:
            ...
            raise AssertionError("Test case failed: The test plan execution failed because the auto-save before file upload was not confirmed and the uploaded file did not appear in the knowledge base storage as expected.")
