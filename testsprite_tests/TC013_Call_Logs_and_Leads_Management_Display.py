...
async def run_test():
    ...
    try:
        ...
        # -> Input email and password for promax@test.com and click Sign In.
        frame = context.pages[-1]
        ...
        frame = context.pages[-1]
        try:
            await expect(frame.locator('text=Call History and Leads Verified Successfully').first).to_be_visible(timeout=1000)
        except AssertionError:
            raise AssertionError("Test case failed: Users cannot view call histories and leads accurately on dashboard pages, or data does not update accordingly upon new calls as per the test plan.")
